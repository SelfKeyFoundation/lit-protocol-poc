...
const API_URL_LOCAL = 'http://0.0.0.0:7007';
const API_URL_PUBLIC = 'https://ceramic-clay.3boxlabs.com';
const API_URL_PUBLIC_2 = 'http://18.141.190.4:7007';
...
class Ceramic {
  ...
  constructor() {
    //this.client = new CeramicClient(API_URL_LOCAL);
    //this.client = new CeramicClient(API_URL_PUBLIC);
    this.client = new CeramicClient(API_URL_PUBLIC_2);
  }
